...
- (void)setup
{
    ...
    self.bgColor = [UIColor colorWithRed:1 green:1 blue:1 alpha:0.8f];
    ...
    [self.cancelButton setTitle:SmaLocalizedString(@"clockadd_cancel") forState:UIControlStateNormal];
...
- (void)updateConstraints
{
    ...
    constraints = [NSLayoutConstraint constraintsWithVisualFormat:@"V:|-8-[titleLabel(==0)]-[iconView]-[cancelButton(==30)]-8-|" options:0 metrics:nil views:views];
    [self.contentView addConstraints:constraints];
