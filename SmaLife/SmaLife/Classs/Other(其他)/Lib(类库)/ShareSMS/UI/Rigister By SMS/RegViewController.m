...
-(void)nextStep
{
    ...
    UIAlertView* alert=[[UIAlertView alloc] initWithTitle:SmaLocalizedString(@"surephonenumber")
...
//        [MBProgressHUD showMessage:@"信息已经发送，请等待接收"];
                                            ...
                                            result:^(SMS_SDKError *error)
        {
            ...
            else
            {
                UIAlertView* alert=[[UIAlertView alloc] initWithTitle:NSLocalizedString(@"codesenderrtitle", nil)
                                                              message:[NSString stringWithFormat:@"%@: %zi ,%@: %@",SmaLocalizedString(@"status_code"),error.errorCode,NSLocalizedString(@"SmaLocalizedString", nil),error.errorDescription]
                                                             delegate:self
                                                    cancelButtonTitle:SmaLocalizedString(@"clockadd_confirm")
                                                    otherButtonTitles:nil, nil];
                [alert show];
...
- (void)viewDidLoad
{
    ...
    areaCodeField.backgroundColor = [UIColor greenColor];
