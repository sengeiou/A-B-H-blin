...
-(void)CannotGetSMS
{
    ...
    UIAlertView* alert=[[UIAlertView alloc] initWithTitle:SmaLocalizedString(@"surephonenumber") message:str delegate:self cancelButtonTitle:SmaLocalizedString(@"clockadd_cancel") otherButtonTitles:SmaLocalizedString(@"clockadd_confirm"), nil];
    _alert1=alert;
    [alert show];
}
...
- (void)viewDidLoad
{
    ...
    _timeLabel.text=SmaLocalizedString(@"timelabel");
