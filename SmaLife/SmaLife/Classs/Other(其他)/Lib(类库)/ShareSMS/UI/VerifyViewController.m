...
{
    UIAlertView* alert=[[UIAlertView alloc] initWithTitle:SmaLocalizedString(@"remind_navtilte")
                                                  message:SmaLocalizedString(@"codedelaymsg")
                                                 delegate:self
                                        cancelButtonTitle:SmaLocalizedString(@"alera_back")
                                        otherButtonTitles:SmaLocalizedString(@"alera_wait"), nil];
    _alert2=alert;
    [alert show];    
}
...
-(void)submit
{
    ...
    {
        UIAlertView* alert=[[UIAlertView alloc] initWithTitle:SmaLocalizedString(@"remind_navtilte")
                                                      message:SmaLocalizedString(@"verifycodeformaterror")
                                                     delegate:self
    ...
    else
    {
        ...
        [SMS_SDK commitVerifyCode:self.verifyCodeField.text result:^(enum SMS_ResponseState state) {
            ...
            {
                NSLog(@"验证成功");
                NSString* str=[NSString stringWithFormat:SmaLocalizedString(@"verifycoderightmsg")];
                UIAlertView* alert=[[UIAlertView alloc] initWithTitle:SmaLocalizedString(@"verifycoderighttitle")
                                                              message:str
                                                             delegate:self
                                                    cancelButtonTitle:SmaLocalizedString(@"clockadd_confirm")
                                                    otherButtonTitles:nil, nil];
...
-(void)CannotGetSMS
{
    NSString* str=[NSString stringWithFormat:@"%@:%@",SmaLocalizedString(@"cannotgetsmsmsg") ,_phone];
    UIAlertView* alert=[[UIAlertView alloc] initWithTitle:SmaLocalizedString(@"surephonenumber") message:str delegate:self cancelButtonTitle:NSLocalizedString(@"SmaLocalizedString", nil) otherButtonTitles:SmaLocalizedString(@"clockadd_confirm"), nil];
    _alert1=alert;
    [alert show];
}
        ...
        if (1==buttonIndex)
        {
            ...
            [SMS_SDK getVerifyCodeByPhoneNumber:_phone AndZone:_areaCode result:^(enum SMS_GetVerifyCodeResponseState state)
            {
                ...
                else if(0==state)
                {
                    ...
                    UIAlertView* alert=[[UIAlertView alloc] initWithTitle:NSLocalizedString(@"codesenderrtitle", nil) message:str delegate:self cancelButtonTitle:SmaLocalizedString(@"clockadd_confirm") otherButtonTitles:nil, nil];
                    [alert show];
                }
                else if (SMS_ResponseStateMaxVerifyCode==state)
                {
                    NSString* str=[NSString stringWithFormat:NSLocalizedString(@"maxcodemsg", nil)];
                    UIAlertView* alert=[[UIAlertView alloc] initWithTitle:NSLocalizedString(@"maxcode", nil) message:str delegate:self cancelButtonTitle:SmaLocalizedString(@"clockadd_confirm") otherButtonTitles:nil, nil];
                    [alert show];
                }
                else if(SMS_ResponseStateGetVerifyCodeTooOften==state)
                {
                    NSString* str=[NSString stringWithFormat:NSLocalizedString(@"codetoooftenmsg", nil)];
                    UIAlertView* alert=[[UIAlertView alloc] initWithTitle:NSLocalizedString(@"remind_navtilte", nil) message:str delegate:self cancelButtonTitle:SmaLocalizedString(@"clockadd_confirm") otherButtonTitles:nil, nil];
                    [alert show];
                }
                                                      ...
                                                      result:^(SMS_SDKError *error)
             {
                 ...
                 if (error)
                 {
                     UIAlertView* alert=[[UIAlertView alloc] initWithTitle:NSLocalizedString(@"codesenderrtitle", nil)
                                                                   message:[NSString stringWithFormat:@"%@: %zi",SmaLocalizedString(@"status_code"),error.errorCode]
                                                                  delegate:self
                                                         cancelButtonTitle:SmaLocalizedString(@"clockadd_confirm")
                                                         otherButtonTitles:nil, nil];
                     [alert show];
...
- (void)viewDidLoad
{
    ...
    UIBarButtonItem *leftButton = [[UIBarButtonItem alloc] initWithTitle:SmaLocalizedString(@"back")
    ...
    label.text=[NSString stringWithFormat:SmaLocalizedString(@"verifylabel")];
    ...
    _verifyCodeField.placeholder=SmaLocalizedString(@"verifycode");
...
//    _timer2=timer2;
//    
//    [MBProgressHUD showMessag:NSLocalizedString(@"sendingin", nil) toView:self.view];
...
-(void)tryVoiceCall
{
    UIAlertView* alert=[[UIAlertView alloc] initWithTitle:NSLocalizedString(@"verificationByVoiceCallConfirm", nil)
                                                 ...
                                                 delegate:self
                                        cancelButtonTitle:SmaLocalizedString(@"clockadd_confirm")
                                        otherButtonTitles:SmaLocalizedString(@"clockadd_cancel"), nil];
