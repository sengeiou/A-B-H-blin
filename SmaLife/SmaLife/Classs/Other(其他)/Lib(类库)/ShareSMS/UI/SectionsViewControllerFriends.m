...
- (void)CustomCellBtnClick:(CustomCell *)cell
{
    ...
    if ([newStr isEqualToString:NSLocalizedString(@"addfriends", nil)])
    {
        ...
        UIAlertView* alert=[[UIAlertView alloc] initWithTitle:NSLocalizedString(@"addfriendstitle", nil) message:NSLocalizedString(@"addfriendsmsg", nil) delegate:self cancelButtonTitle:SmaLocalizedString(@"clockadd_confirm") otherButtonTitles:nil, nil];
        [alert show];
    }
